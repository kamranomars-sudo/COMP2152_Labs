...
class Report:
    ...
    def summary(self):
        ...
        print(f"  High Severity: {len(self.get_by_severity('HIGH'))}")
        print(f"  Medium Severity: {len(self.get_by_severity('MEDIUM'))}")
        print(f"  Low Severity: {len(self.get_by_severity('LOW'))}")
        print("=" * 50)
